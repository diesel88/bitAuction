...
<div class="row">
	...
	<div class="col-md-8">
		<form class="form-horizontal" action="updateAuction.do" method="post" enctype="multipart/form-data">
			<input type="hidden" name="acNo" value="${auction.acNo }"/>
			<div class="form-group">
				<label><div>경매 물품 수정</div></label>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="acNm" name="acNm" value="${auction.acNm }">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea class="form-control" id="acContent" name="acContent" 
						rows="10"
						><c:out value="${auction.acContent }"/></textarea>
				</div>
			</div>
