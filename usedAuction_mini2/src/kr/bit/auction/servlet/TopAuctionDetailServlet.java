...
@WebServlet("/auction/topDetail.do")
public class TopAuctionDetailServlet extends HttpServlet{
	SqlSession session = null;
	AuctionMapper mapper = null;
	
	public TopAuctionDetailServlet() {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<AuctionVO> list = mapper.selectTopAuction(select);
		...
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/auction/topDetail.jsp");
